...
const Component = () => {
  const [getAllVacancies, loa, setAllVacancies] = useVacanciesApi();
      ...
      <Row>
        <Col lg="12" className="mb-3">
          <Row>
            ...
            <Col lg="3">
              <Input  onChange={ event => console.log(_.filter(setAllVacancies, field => field.name === event.target.value )) }/>
            </Col>
            <Col lg="2">
              <Select
                    placeholder={"Статус"}
                    ...
                    onChange={ (value) => { console.log(_.filter(setAllVacancies, field => field.status === value.value )); } }
                    />
            </Col>
            <Col lg="2">
              <Select
