...
const Component = () => {
  ...
  console.log( _.filter(getAllVacancies, { 'age': 36, 'active': true });)
          ...
          <Row>
            ...
            <Col lg="2">
              <Select
                    ...
                    onChange={ (value) => { setVacanciesFiltered(_.filter(getAllVacancies, field => field.status === value.value )); } }
                    />
            </Col>
            <Col lg="2">
              <Select
                  ...
                  onChange={ (value) => {setFilters((array)=> {})} }
                  />
            </Col>
            <Col lg="2">
              <Select
