...
const Component = () => {
  ...
  //filteredVacancy = fuse.search(filters.name);
  const toggle = () => {
   ...
   //setVacanciesFiltered( event.target.value ? fuse.search(event.target.value) : getAllVacancies );
  console.log(fuse.search(filters.name));
              ...
              <Input onChange={ 
                event => { 
                  if(event.target.value) {
                    ...
                    //setVacanciesFiltered(fuse.search(filters.name));
                    setVacanciesFiltered(fuse.search(query)); 
                  } else {
                    delete filters.name;
                    setFilters(filters); 
                  }                
